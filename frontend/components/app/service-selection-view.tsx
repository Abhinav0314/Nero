...
function ServiceIcon({
  ...
  type: 'chat' | 'coffee' | 'wellness' | 'tutor' | 'sdr' | 'fraud' | 'grocery' | 'game-master';
}) {
  if (type === 'chat') {
    return (
      <svg
    ...
    return (
      ...
      >
        <path
          ...
          fill="currentColor"
        />
        <path d="M24 12H40V16H24V12Z" fill="currentColor" />
      </svg>
    );
  }

  // game-master - dice icon
  return (
    <svg
      width="48"
      height="48"
    ...
    >
      <path
        d="M32 8L8 20V44L32 56L56 44V20L32 8ZM32 12L52 22V42L32 52L12 42V22L32 12ZM32 24C30.9 24 30 24.9 30 26C30 27.1 30.9 28 32 28C33.1 28 34 27.1 34 26C34 24.9 33.1 24 32 24ZM20 30C18.9 30 18 30.9 18 32C18 33.1 18.9 34 20 34C21.1 34 22 33.1 22 32C22 30.9 21.1 30 20 30ZM44 30C42.9 30 42 30.9 42 32C42 33.1 42.9 34 44 34C45.1 34 46 33.1 46 32C46 30.9 45.1 30 44 30ZM26 36C24.9 36 24 36.9 24 38C24 39.1 24.9 40 26 40C27.1 40 28 39.1 28 38C28 36.9 27.1 36 26 36ZM38 36C36.9 36 36 36.9 36 38C36 39.1 36.9 40 38 40C39.1 40 40 39.1 40 38C40 36.9 39.1 36 38 36Z"
        fill="currentColor"
      />
    </svg>
  );
    ...
    <div ref={ref}>
      <section className="bg-background flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="grid w-full max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            href="/chat"
            className="bg-card hover:bg-accent/10 border-border group block rounded-lg border p-6 text-center transition-all duration-200 hover:scale-105 hover:shadow-lg"
          >
            <div className="flex flex-col items-center">
              <ServiceIcon type="chat" />
              <h3 className="text-foreground mb-2 text-xl font-semibold">General Chat</h3>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">Coffee Ordering</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">Wellness Check-in</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">Active Recall Tutor</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">SDR Assistant</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">Fraud Alert</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-foreground mb-2 text-xl font-semibold">Grocery Ordering</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            <div className="flex flex-col items-center">
              <ServiceIcon type="game-master" />
              <h3 className="text-foreground mb-2 text-xl font-semibold">D&D Game Master</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Embark on a voice-based D&D adventure
              </p>
            </div>
          </Link>
        </div>
